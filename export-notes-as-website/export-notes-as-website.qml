...
Script {
    ...
    property variant settingsVariables: [
        {
            ...
            "default": "opt1",
            "items": {
                "opt1": "Save files in each notebook (original behavior).",
                "opt2": "Save files in central location."
            }
        },
        {
     ...
     */
    function init() {
        script.registerCustomAction("exportWebsite", "Export notes as website", "", "applications-internet", false, true, true);
    }
