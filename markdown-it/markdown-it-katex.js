...
(function (factory) {
  ...
  var isValidDelim = function isValidDelim(state, pos, allowInlineWithSpace) {
    var prevChar = state.src.charAt(pos - 1);
  ...
  var getInlineTex = function getInlineTex(allowInlineWithSpace) {
    return function (state, silent) {
      if (state.src[state.pos] !== "$") return false;
      var delimState = isValidDelim(state, state.pos, allowInlineWithSpace);
  ...
  var blockTex = function blockTex(state, start, end, silent) {
    ...
    token.content =
      ...
      (lastLine ? "".concat(lastLine, "\n") : "");
    token.map = [start, state.line];
    token.markup = "$$";
    return true;
  };
  var tex = function tex(md, options) {
    if (
    ...
    var _options$allowInlineW = options.allowInlineWithSpace,
      allowInlineWithSpace =
        _options$allowInlineW === void 0 ? false : _options$allowInlineW,
      _options$mathFence = options.mathFence,
      mathFence = _options$mathFence === void 0 ? false : _options$mathFence,
    ...
    md.renderer.rules.math_inline = function (tokens, index, _options, env) {
      return render(tokens[index].content, false, env);
    };
    md.renderer.rules.math_block = function (tokens, index, _options, env) {
      return render(tokens[index].content, true, env);
    };
  };
  var SourceLocation = (function () {
    ...
    return _createClass(SourceLocation, null, [
      {
        key: "range",
  ...
  var ParseError = _createClass(function ParseError(message, token) {
    ...
    return _createClass(Options, [
      ...
      },
      {
        ...
        value: function havingBaseStyle(style) {
          ...
          if (
            ...
            return this.extend({ style: style, size: wantSize });
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function withTextFontFamily(fontFamily) {
          return this.extend({ fontFamily: fontFamily, font: "" });
        },
      },
      {
        key: "withTextFontWeight",
        value: function withTextFontWeight(fontWeight) {
          return this.extend({ fontWeight: fontWeight, font: "" });
        },
      },
      {
        key: "withTextFontShape",
        value: function withTextFontShape(fontShape) {
          return this.extend({ fontShape: fontShape, font: "" });
        },
      },
      {
        key: "sizingClasses",
  ...
  var SymbolNode = (function () {
    ...
    return _createClass(SymbolNode, [
      {
        key: "hasClass",
        value: function hasClass(className) {
          return utils.contains(this.classes, className);
  ...
  var ATOMS = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 };
  var NON_ATOMS = {
    "accent-token": 1,
    mathord: 1,
    "op-token": 1,
  ...
  var ligatures = { "--": true, "---": true, "``": true, "''": true };
  ...
  var makeOrd = function makeOrd(group, options, type) {
    ...
    if (text.charCodeAt(0) === 55349) {
      ...
      var _wideCharacterFont2 = _slicedToArray(_wideCharacterFont, 2);
  ...
  var getVListChildrenAndDepth = function getVListChildrenAndDepth(params) {
    if (params.positionType === "individualShift") {
      ...
      return { children: children, depth: _depth };
    }
    var depth;
  ...
  var thinspace = { number: 3, unit: "mu" };
  var mediumspace = { number: 4, unit: "mu" };
  var thickspace = { number: 5, unit: "mu" };
  var spacings = {
    mord: {
      mop: thinspace,
      mbin: mediumspace,
      ...
      if (_group instanceof MathNode && lastGroup instanceof MathNode) {
        if (
          ...
          (_lastGroup$children = lastGroup.children).push.apply(
            _lastGroup$children,
            _toConsumableArray(_group.children),
          );
          continue;
          ...
          _group.children = [].concat(
            _toConsumableArray(lastGroup.children),
            _toConsumableArray(_group.children),
          );
          groups.pop();
        } else if (
          ...
          if (base instanceof MathNode && base.type === "mn") {
            base.children = [].concat(
              _toConsumableArray(lastGroup.children),
              _toConsumableArray(base.children),
            );
            groups.pop();
          }
  ...
  function cdArrow(arrowChar, labels, parser) {
    ...
    switch (funcName) {
      ...
      case "\\Vert": {
        var arrow = { type: "textord", text: "\\Vert", mode: "math" };
  ...
  defineFunction({
    ...
    handler: function handler(_ref2, args) {
      var parser = _ref2.parser;
      return { type: "cdlabelparent", mode: parser.mode, fragment: args[0] };
    },
    htmlBuilder: function htmlBuilder(group, options) {
  ...
  var lapInEms = 0.008;
  var lap = { type: "kern", size: -1 * lapInEms };
  ...
  var makeStackedDelim = function makeStackedDelim(
    ...
    var inner = buildCommon.makeVList(
      { positionType: "bottom", positionData: depth, children: stack },
      newOptions,
    );
    return styleWrap(
  ...
  var htmlBuilder$7 = function htmlBuilder$7(group, options) {
    ...
    if (label === "sout") {
      ...
      var lineWeight = calculateSize({ number: 0.6, unit: "pt" }, options);
  ...
  var mathmlBuilder$6 = function mathmlBuilder$6(group, options) {
    var fboxsep = 0;
  ...
  var htmlBuilder$6 = function htmlBuilder(group, options) {
    ...
    if (
      ...
      for (r = 0; r < nr; ++r) {
        ...
        tagSpans.push({ type: "elem", elem: tagSpan, shift: shift });
      }
    }
    for (
      c = 0, colDescrNum = 0;
      ...
      for (r = 0; r < nr; ++r) {
        ...
        col.push({ type: "elem", elem: elem, shift: _shift2 });
      }
      col = buildCommon.makeVList(
        { positionType: "individualShift", children: col },
        options,
      );
  ...
  var alignMap = { c: "center ", l: "left ", r: "right " };
  ...
  var alignedHandler = function alignedHandler(context, args) {
    ...
    var numMaths;
    var numCols = 0;
    var emptyGroup = { type: "ordgroup", mode: context.mode, body: [] };
    ...
    for (var _i5 = 0; _i5 < numCols; ++_i5) {
      ...
      cols[_i5] = { type: "align", align: align, pregap: pregap, postgap: 0 };
    }
  ...
  defineEnvironment({
    ...
    handler: function handler(context, args) {
      ...
      var res = { cols: cols, hskipBeforeAndAfter: false, arraystretch: 0.5 };
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      ...
      if (funcName === "\\begin") {
        ...
        var context = { mode: parser.mode, envName: envName, parser: parser };
  ...
  defineFunction({
    ...
    handler: function handler(_ref2, args) {
      ...
      return {
        ...
        body: [
          { type: "font", mode: parser.mode, font: "boldsymbol", body: body },
        ],
        isCharacterBox: isCharacterBox,
      };
    },
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      ...
      if (!parser.settings.isTrusted({ command: "\\href", url: href })) {
  ...
  defineFunction({
    ...
    handler: function handler(_ref2, args) {
      var parser = _ref2.parser;
      var href = assertNodeType(args[0], "url").url;
      if (!parser.settings.isTrusted({ command: "\\url", url: href })) {
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      var parser = _ref.parser;
      return { type: "hbox", mode: parser.mode, body: ordargument(args[0]) };
    },
    htmlBuilder: function htmlBuilder(group, options) {
      var elements = buildExpression$1(group.body, options, false);
      return buildCommon.makeFragment(elements);
  ...
  defineFunction({
    ...
    htmlBuilder: function htmlBuilder(group, options) {
      ...
      if (group.attributes["class"]) {
        classes.push.apply(
          classes,
          _toConsumableArray(group.attributes["class"].trim().split(/\s+/)),
        );
      }
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args, optArgs) {
      var parser = _ref.parser;
      var width = { number: 0, unit: "em" };
      var height = { number: 0.9, unit: "em" };
      var totalheight = { number: 0, unit: "em" };
      var alt = "";
      if (optArgs[0]) {
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      ...
      return { type: "styling", mode: parser.mode, style: style, body: body };
    },
    htmlBuilder: function htmlBuilder(group, options) {
  ...
  var defaultVariant = { mi: "italic", mn: "normal", mtext: "normal" };
  defineFunctionBuilders({
    type: "mathord",
    htmlBuilder: function htmlBuilder(group, options) {
  ...
  var textFontWeights = { "\\textbf": "textbf", "\\textmd": "textmd" };
  var textFontShapes = { "\\textit": "textit", "\\textup": "textup" };
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      var parser = _ref.parser;
      return { type: "underline", mode: parser.mode, body: args[0] };
    },
    htmlBuilder: function htmlBuilder(group, options) {
  ...
  defineFunction({
    ...
    handler: function handler(_ref, args) {
      var parser = _ref.parser;
      return { type: "vcenter", mode: parser.mode, body: args[0] };
    },
    htmlBuilder: function htmlBuilder(group, options) {
      var body = buildGroup$1(group.body, options);
      var axisHeight = options.fontMetrics().axisHeight;
  ...
  var newcommand = function newcommand(
    ...
    if (!(exists && skipIfExists)) {
      context.macros.set(name, { tokens: arg, numArgs: numArgs });
    }
    return "";
  };
  defineMacro("\\newcommand", function (context) {
    return newcommand(context, false, true, false);
  });
  defineMacro("\\renewcommand", function (context) {
    return newcommand(context, true, false, false);
  });
  defineMacro("\\providecommand", function (context) {
    return newcommand(context, true, true, true);
  });
    ...
    return function (context) {
      ...
      var expanded = context.expandTokens(
        [].concat(
          ...
          _toConsumableArray(arg),
          _toConsumableArray(left),
        ),
      );
      context.macros.endGroup();
      return { tokens: expanded.reverse(), numArgs: 0 };
    };
  };
  ...
  var MacroExpander = (function () {
    ...
    return _createClass(MacroExpander, [
      {
        key: "feed",
      ...
      {
        key: "countExpansion",
        value: function countExpansion(amount) {
              ...
              if (tok.text === "#") {
                ...
                if (tok.text === "#") {
                  ...
                  (_tokens = tokens).splice.apply(
                    _tokens,
                    [i, 2].concat(_toConsumableArray(args[+tok.text - 1])),
                  );
                } else {
    ...
    return _createClass(Parser, [
      ...
      },
      {
        ...
        value: function formatUnsupportedCmd(text) {
          ...
          var textNode = { type: "text", mode: this.mode, body: textordArray };
          var colorNode = {
            type: "color",
            mode: this.mode,
      ...
      {
        key: "parseFunction",
        value: function parseFunction(breakOnTokenText, name) {
        ...
        value: function parseGroupOfType(name, type, optional) {
          switch (type) {
            ...
            case "raw": {
              ...
              return token != null
                ? { type: "raw", mode: "text", string: token.text }
                : null;
            }
            case "primitive": {
              if (optional) {
      ...
      },
      {
        ...
        value: function parseColorGroup(optional) {
          ...
          return { type: "color-token", mode: this.mode, color: color };
        },
      },
      {
        key: "parseSizeGroup",
      ...
      },
      {
        ...
        value: function parseUrlGroup(optional) {
          ...
          return { type: "url", mode: this.mode, url: url };
        },
      },
      {
      ...
      {
        key: "parseGroup",
        value: function parseGroup(name, breakOnTokenText) {
          var firstToken = this.fetch();
      ...
      },
      {
        ...
        value: function parseSymbol() {
          ...
          if (/^\\verb[^a-zA-Z]/.test(text)) {
            ...
            arg = arg.slice(1, -1);
            return { type: "verb", mode: "text", body: arg, star: star };
          }
          if (
          ...
          if (symbols[this.mode][text]) {
            ...
            if (ATOMS.hasOwnProperty(group)) {
              ...
              s = { type: group, mode: this.mode, loc: loc, text: text };
            }
            symbol = s;
  ...
  var katexInline = function katexInline(tex, options, transformer) {
    var _transformer;
    var result;
    try {
      result = renderToString(
        tex,
        _objectSpread(_objectSpread({}, options), {}, { displayMode: false }),
      );
    } catch (error) {
      if (error instanceof ParseError) {
        console.warn(error);
        result = "<span class='katex-error' title='"
          .concat(escapeHtml(error.toString()), "'>")
          .concat(escapeHtml(tex), "</span>");
      } else {
        throw error;
      }
    }
    return (_transformer =
      transformer === null || transformer === void 0
        ? void 0
        : transformer(result, false)) !== null && _transformer !== void 0
      ? _transformer
      : result;
  };
  var katexBlock = function katexBlock(tex, options, transformer) {
    var _transformer2;
    var result;
    try {
      result = "<p class='katex-block'>".concat(
        renderToString(
          tex,
          _objectSpread(_objectSpread({}, options), {}, { displayMode: true }),
        ),
        "</p>\n",
      );
    } catch (error) {
      if (error instanceof ParseError) {
        console.warn(error);
        result = "<p class='katex-block katex-error' title='"
          .concat(escapeHtml(error.toString()), "'>")
          .concat(escapeHtml(tex), "</p>\n");
      } else {
        throw error;
      }
    }
    return (_transformer2 =
      transformer === null || transformer === void 0
        ? void 0
        : transformer(result, true)) !== null && _transformer2 !== void 0
      ? _transformer2
      : result;
  };
  var katex = function katex(md) {
    var options =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var _options$allowInlineW2 = options.allowInlineWithSpace,
      allowInlineWithSpace =
        _options$allowInlineW2 === void 0 ? false : _options$allowInlineW2,
      _options$mathFence2 = options.mathFence,
      mathFence = _options$mathFence2 === void 0 ? false : _options$mathFence2,
      _options$logger = options.logger,
      logger =
        _options$logger === void 0
          ? function (errorCode) {
              return errorCode === "newLineInDisplayMode" ? "ignore" : "warn";
            }
          : _options$logger,
      _options$macros = options.macros,
      macros = _options$macros === void 0 ? {} : _options$macros,
      transformer = options.transformer,
      userOptions = _objectWithoutProperties(options, _excluded);
    md.use(tex, {
      allowInlineWithSpace: allowInlineWithSpace,
      mathFence: mathFence,
      render: function render(content, displayMode, env) {
        var katexOptions = _objectSpread(
          {
            strict: function strict(errorCode, errorMsg, token) {
              var _logger;
              return (_logger = logger(errorCode, errorMsg, token, env)) !==
                null && _logger !== void 0
                ? _logger
                : "ignore";
            },
