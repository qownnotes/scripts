...
Script {
    ...
    function getPyCommand() {
        if (script.startSynchronousProcess('pythonw', '-V', '').toString().indexOf('Python 3') != '-1') {
            return 'pythonw';
        }
        if (script.startSynchronousProcess('python3', '-V', '').toString().indexOf('Python 3') != '-1') {
            return 'python3';
        }
        if (script.startSynchronousProcess('python', '-V', '').toString().indexOf('Python 3') != '-1') {
            return 'python';
        }
        return '';
    }
